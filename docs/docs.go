...
const docTemplate = `{
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.userItem"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        "graphdiff.Change": {
            ...
            "properties": {
                ...
                "fields": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/graphdiff.FieldChange"
                    }
                },
                "orbId": {
                    "type": "string"
        ...
        "handler.changeEffect": {
            ...
            "properties": {
                "before": {
                    "description": "Before is the value being replaced. Only an EFFECT-derived summary can\nknow it — a payload states what a field becomes, never what it was — so it\nis absent on rows created before base_effect existed, and a client must\nrender ` + "`" + `→ after` + "`" + ` when it is missing rather than assume null meant empty."
                },
                "cleared": {
                    "description": "Cleared distinguishes \"set to nothing\" from \"set to a falsy value\" —\n` + "`" + `Value` + "`" + ` alone cannot, since ` + "`" + `false` + "`" + ` and ` + "`" + `0` + "`" + ` are legitimate values.",
                    "type": "boolean",
                    "example": false
                },
                "entities": {
                    "description": "Entities is how many distinct orbIds the changeset touches.",
                    "type": "integer",
                    "example": 1
                },
                "field": {
                    "description": "Field, Value and Cleared are present ONLY when Fields == 1 — the case a\nrow can state in full rather than count.",
                    "type": "string",
                    "example": "manufacturer"
                },
                "fields": {
                    "description": "Fields is the total across every item, counting a cleared field once.",
                    "type": "integer",
                    "example": 1
                },
                "orbId": {
                    "description": "OrbID and Type are present whenever the changeset touches exactly ONE\nentity, whatever its field count — a row saying \"3 fields\" without saying\non what is a worse answer than the count alone.",
                    "type": "string",
                    "example": "colo:server-1W8Y2Z3"
                },
                "type": {
                    "type": "string",
                    "example": "Server"
        ...
        "handler.errorResponse": {
            ...
            "properties": {
                ...
                "error": {
                    "type": "string",
                    "example": "dev or admin role required for mutations"
                },
                "hint": {
                    "type": "string",
                    "example": "Ask an admin to grant you the dev role."
                },
                "httpStatus": {
                    "type": "integer",
                    "example": 403
        ...
        "handler.lastPublishedMeta": {
            ...
            "properties": {
                ...
                "state": {
                    "description": "published | first_export | unavailable",
                    "type": "string",
                    "example": "published"
                },
                "tag": {
        ...
        "handler.previewResponse": {
            ...
            "properties": {
                ...
                "current": {
                    "$ref": "#/definitions/handler.currentMeta"
                },
                "dataCenterName": {
                    "type": "string",
                    "example": "colo-galleon"
                ...
                "lastPublishedVersion": {
                    "$ref": "#/definitions/handler.lastPublishedMeta"
                },
                "orbId": {
                    "type": "string",
                    "example": "colo:colo-galleon"
                },
                "summary": {
                    "$ref": "#/definitions/graphdiff.Summary"
                }
