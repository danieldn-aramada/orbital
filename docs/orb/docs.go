...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/divergence.OverrideEntry"
                            }
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/orbserver.intakePayload"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/divergence/publish-history": {
            "get": {
        ...
        "/api/v1/divergence/test-connection": {
            "post": {
    ...
    "definitions": {
        "divergence.OverrideEntry": {
            ...
            "properties": {
                ...
                "overrideValue": {},
                "type": {
                    "description": "orbital GraphQL type name (e.g. \"Server\"); empty for legacy producers",
                    "type": "string"
                },
                "when": {
                    "type": "string"
