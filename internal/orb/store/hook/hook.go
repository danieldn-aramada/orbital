...
type ImportRecordFunc func(context.Context, *store.ImportRecordMutation) (store.Value, error)

// Mutate calls f(ctx, m).
func (f ImportRecordFunc) Mutate(ctx context.Context, m store.Mutation) (store.Value, error) {
	if mv, ok := m.(*store.ImportRecordMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *store.ImportRecordMutation", m)
}

// The PendingOverrideFunc type is an adapter to allow the use of ordinary
// function as PendingOverride mutator.
type PendingOverrideFunc func(context.Context, *store.PendingOverrideMutation) (store.Value, error)

// Mutate calls f(ctx, m).
func (f PendingOverrideFunc) Mutate(ctx context.Context, m store.Mutation) (store.Value, error) {
	if mv, ok := m.(*store.PendingOverrideMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *store.PendingOverrideMutation", m)
}

// The PublishedReportFunc type is an adapter to allow the use of ordinary
// function as PublishedReport mutator.
type PublishedReportFunc func(context.Context, *store.PublishedReportMutation) (store.Value, error)

// Mutate calls f(ctx, m).
func (f PublishedReportFunc) Mutate(ctx context.Context, m store.Mutation) (store.Value, error) {
	if mv, ok := m.(*store.PublishedReportMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *store.PublishedReportMutation", m)
}
