...
func (_q *ImportRecordQuery) First(ctx context.Context) (*ImportRecord, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{importrecord.Label}
	}
	return nodes[0], nil
}
...
func (_q *ImportRecordQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *ImportRecordQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *ImportRecordQuery) Only(ctx context.Context) (*ImportRecord, error) {
	...
	case 0:
		return nil, &NotFoundError{importrecord.Label}
	default:
		return nil, &NotSingularError{importrecord.Label}
	}
}
...
func (_q *ImportRecordQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
	...
	case 0:
		err = &NotFoundError{importrecord.Label}
	default:
		err = &NotSingularError{importrecord.Label}
	}
	return
}

// OnlyIDX is like OnlyID, but panics if an error occurs.
func (_q *ImportRecordQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *ImportRecordQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *ImportRecordQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ImportRecordQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(importrecord.Table, importrecord.Columns, sqlgraph.NewFieldSpec(importrecord.FieldID, field.TypeUUID))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		for i := range fields {
			if fields[i] != importrecord.FieldID {
...
// ImportRecordGroupBy is the group-by builder for ImportRecord entities.
type ImportRecordGroupBy struct {
	selector
	build *ImportRecordQuery
}
...
// ImportRecordSelect is the builder for selecting fields of ImportRecord entities.
type ImportRecordSelect struct {
	*ImportRecordQuery
	selector
}
