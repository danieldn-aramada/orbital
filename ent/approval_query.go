...
func (_q *ApprovalQuery) QueryRequest() *ApprovalRequestQuery {
...
func (_q *ApprovalQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *ApprovalQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *ApprovalQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *ApprovalQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *ApprovalQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *ApprovalQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ApprovalQuery) WithRequest(opts ...func(*ApprovalRequestQuery)) *ApprovalQuery {
	query := (&ApprovalRequestClient{config: _q.config}).Query()
...
func (_q *ApprovalQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Approval, error) {
	...
	if query := _q.withRequest; query != nil {
		if err := _q.loadRequest(ctx, query, nodes, nil,
			func(n *Approval, e *ApprovalRequest) { n.Edges.Request = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ApprovalQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withRequest != nil {
			_spec.Node.AddColumnOnce(approval.FieldApprovalRequestID)
		}
	}
